        ...
        if (contenttype != String.Empty)
        {
            ...
            using (SqlConnection con = new SqlConnection(CS))
            {
                ...
                else
                {
                    ...
                    string strQuery = "insert into UserTable(Name, Address, Email, Password , Gender,DateOfBirth,MobileNo,Image,ContentType) values (@Name, @Address, @Email,@Password,@Gender,@DateOfBirth,@MobileNo,@Image,@ContentType)";
