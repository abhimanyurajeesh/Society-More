...
public partial class MLogin : System.Web.UI.Page
{
    ...
    protected void btnLogin_Click(object sender, EventArgs e)
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("select * from MemberTable where Email='" + txtEmail.Text + "' and Password='" + txtPassword.Text + "'", con);
            con.Open();
            ...
            if (dt.Rows.Count != 0)
            {
                ...
                Session["SocietyName"] = dt.Rows[0]["SocietyName"].ToString();
                Session["BlockNo"] = dt.Rows[0]["BlockNo"].ToString();
